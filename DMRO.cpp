...
public:
    ...
    data() : city{"Mehrouli", "Noida Electronic City", "Sector 18", "Hauz Khaz", "CP", "Okla", "shaheen Bagh", "Chirag Delhi", "INA", "Sector 52", "Indirapuram", "Botanical Garden", "Sector 59", "Sikandarpur", "Preet Vihar"} {}
...
public:
    ...
    bool duplicate(string username) {
        ifstream readf("login.txt");
        while (readf >> username1) {
    ...
    bool log_in(string username, string password) {
        ifstream readf("login.txt");
        while (readf >> username1 >> password1) {
    ...
    void acc(string username, string password) {
    ...
    void ticket(string username, string first[], string last[], string sex[], int age[], int no) {
        ofstream filewrite("ticket.txt", ios::app);
        for (int i = 0; i < no; i++) {
            filewrite << username << " " << first[i] << " " << last[i] << " " << sex[i] << " " << age[i] << "\n";
        }
        filewrite.close();
    }
};
        ...
        while (true) {
            ...
            switch (ch) {
                ...
                case 2: {
                    ...
                    cin >> password;
                    cout << "*****************************************" << endl;
                    res2 = fobj.duplicate(username);
                    if (res2 == 1)
                        fobj.acc(username, password);
                    else
...
public:
    ...
    void detail(int no, string first[], string last[], string sex[], int age[]) {
        for (int i = 0; i < no; i++) {
            ...
            for (int j = 0; j < N; j++) {
                if (source == o.city[i] && destination == o.city[j]) {
                    ...
                    if (c == 'Y' || c == 'y') {
                        ...
                        string first[no], last[no], sex[no];
                        int age[no];
                        for (int i = 0; i < no; i++) {
                            cout << endl;
                            cout << "*****************************************" << endl;
                        ...
                        if (y == 'Y' || y == 'y') {
                            fileh f;
                            f.ticket(username, first, last, sex, age, no);
                            ticket(total_price, no, source, destination, username);
                            detail(no, first, last, sex, age);
                        } else {
